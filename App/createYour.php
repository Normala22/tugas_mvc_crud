            ...
            <div class="col-md-5 border rounded mt-2">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="id_input" name="idInput">
                    </div>
                    <div class="mb-3">
                        <label for="nik_input" class="form-label">NIK</label>
                        <input type="text" class="form-control" id="nik_input" name="nikInput">
                    </div>
                    <div class="mb-3">
...
if (isset($_POST["submit"])){
    $userController->createYour($_POST['nikInput'], $_POST['alamatInput'], $_POST['hobiInput'], $_POST['idInput']);
