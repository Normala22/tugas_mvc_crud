            ...
            <div class="col-md-5 border rounded mt-2">
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="idInput" id="id_input">
                    </div>
                    <div class="mb-3">
...
if (isset($_POST["submit"])){
    echo $_POST['idInput'], $_POST['namaInput'], $_POST['pekerjaanInput'];
    $userController->createMine((int) $_POST['idInput'], $_POST['namaInput'], $_POST['pekerjaanInput']);
